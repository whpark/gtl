...
BEGIN_MESSAGE_MAP(CClassView, CDockablePane)
	...
	ON_COMMAND(ID_CLASS_ADD_MEMBER_VARIABLE, &CClassView::OnClassAddMemberVariable)
	ON_COMMAND(ID_CLASS_DEFINITION, &CClassView::OnClassDefinition)
	ON_COMMAND(ID_CLASS_PROPERTIES, &CClassView::OnClassProperties)
