...
BEGIN_MESSAGE_MAP(CPropertiesWnd, CDockablePane)
	...
	ON_COMMAND(ID_PROPERTIES1, &CPropertiesWnd::OnProperties1)
	ON_UPDATE_COMMAND_UI(ID_PROPERTIES1, &CPropertiesWnd::OnUpdateProperties1)
	ON_COMMAND(ID_PROPERTIES2, &CPropertiesWnd::OnProperties2)
	ON_UPDATE_COMMAND_UI(ID_PROPERTIES2, &CPropertiesWnd::OnUpdateProperties2)
	ON_WM_SETFOCUS()
	ON_WM_SETTINGCHANGE()
END_MESSAGE_MAP()
