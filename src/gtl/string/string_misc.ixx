...
export namespace gtl {
	...
	namespace charset {
		...
		constexpr S_ULPair<char16_t> latin1_diff { 0xC0, 0xE0 };	// À, à'
		constexpr S_ULPair<char16_t> latin1_exception1 { 0x00D7, 0x00F7 }; // ×, ÷
		constexpr S_ULPair<char16_t> latin1_exception2 { 0x039c, 0x00b5 }; // µ, Μ : 743
		constexpr S_ULPair<char16_t> latin1_exception3 { 0x0178, 0x00ff }; // ÿ, Ÿ : 121
		...
		std::array<S_MAP_TABLE<char16_t>, 4> mapUL16 { {
		...
		std::array<S_MAP_TABLE<char16_t>, 5> mapLU16 { {
