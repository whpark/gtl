...
#pragma pack(push, 8)
	...
	// obsolete
	template < gtlc::string_elem tchar_to, gtlc::string_elem tchar_from, size_t initial_dst_buf_size = 1024 >
	GTL__DEPRECATED std::optional<std::basic_string<tchar_to>> ToString_iconv(std::basic_string_view<tchar_from> svFrom, char const* szCodeTo, char const* szCodeFrom = nullptr) {
		return Ticonv<tchar_to, tchar_from, initial_dst_buf_size>{szCodeTo, szCodeFrom}.Convert(svFrom);
	}
	template < gtlc::string_elem tchar_to, gtlc::string_elem tchar_from, size_t initial_dst_buf_size = 1024 >
	GTL__DEPRECATED std::optional<std::basic_string<tchar_to>> ToString_iconv(std::basic_string<tchar_from> const& strFrom, char const* szCodeTo, char const* szCodeFrom = nullptr) {
