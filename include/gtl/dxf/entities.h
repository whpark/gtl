...
//////////////////////////////////////////////////////////////////////
//
// entities.h : DXF entities
//
// PWH
// 2026-09-02 ported from biscuit.dxf (module :entities) to gtl.dxf (header)
//
//////////////////////////////////////////////////////////////////////
...
namespace gtl::dxf::entities {
	...
	template class		TEntityDerived<eENTITY::unknown, "UNKNOWN", sUnknown>;
