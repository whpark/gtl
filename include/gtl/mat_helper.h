...
#pragma pack(pop)
	...
	/// @return
	GTL__API bool SaveBitmapMat(std::filesystem::path const& path, cv::Mat const& img, int nBPP, gtl::xSize2i const& pelsPerMeter, std::span<gtl::color_bgra_t const> palette = {}, bool bConvertMatValueToPaletteIndex = false, bool bBottom2Top = false, callback_progress_t funcCallback = nullptr);
