...
// 2000.????
// 2021.06.10 gtl.
// 2023-08-09 win_util -> mfc (win/mfc 분리)
//
///////////////////////////////////////////////////////////////////////////////
...
#pragma pack(push, 8)	// default align. (8 bytes)
	...
	GTL__MFC_API gtl::xString GetErrorMessage(CException& e);

	//-----------------------------------------------------------------------------
	// Rect Tracker with Center Cross Mark
	class GTL__MFC_CLASS CRectTrackerCenterMark : public CRectTracker {
	public:
